...
//!
//! This module handles the display of OLAP infrastructure changes.
...
//! - `show_olap_changes()`: OLAP change handler
//!
//! ### Helper Functions
...
use crate::framework::core::{
    ...
    infrastructure_map::{Change, FilteredChange, OlapChange, TableChange},
    plan::InfraPlan,
};
...
/// - **Filtered Changes**: Changes blocked by lifecycle policies
///
/// # Examples
///
/// ```rust
...
mod tests {
    ...
    fn test_show_functions_exist() {
        ...
        let _f2: fn(&InfraPlan) = show_changes;
    }
