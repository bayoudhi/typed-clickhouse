use crate::utilities::constants::CLI_USER_DIRECTORY;
use home::home_dir;
use std::fs;
...
const MACHINE_ID_FILE_NAME: &str = "machine_id";

/// Gets or creates a tracking ID from `~/{CLI_USER_DIRECTORY}/machine_id`
...
fn get_machine_id_path() -> PathBuf {
    home_dir()
        ...
        .join(CLI_USER_DIRECTORY)
        .join(MACHINE_ID_FILE_NAME)
}
