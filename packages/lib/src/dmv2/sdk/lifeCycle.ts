/**
 * Defines how the library manages the lifecycle of database resources when your code changes.
 *
...
export enum LifeCycle {
   ...
   * the library will automatically modify database resources to match your code definitions,
   ...
   * the library will modify resources to match your code but will avoid destructive actions
   ...
   * the library will not modify the database resources. You are responsible for managing
